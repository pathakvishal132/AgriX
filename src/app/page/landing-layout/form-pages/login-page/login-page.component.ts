...
export class LoginPageComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // for (const websiteName in environmentCommon.website) {
    //    let website = environmentCommon.website[websiteName];
    //   if (website?.websiteType === 'oauth') {
  ...
  onSubmit() {
    ...
    const errorMessages = {
      username: `:@@loginPage.error.username:Please provide a valid username`,
      password: `:@@loginPage.error.password:Please provide a valid password`,
    };
